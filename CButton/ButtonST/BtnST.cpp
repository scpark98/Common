...
DWORD CButtonST::OnDrawBorder(CDC* pDC, CRect* pRect)
{
	...
	else // ...else draw non pressed button
	{
		...
		{
			//scpark.
			//원래 마우스온을 체크하는 루틴이지만 기본적으로 얇은 보더를 그리기 위해 막는 것을 기본으로 한다.
...
/*
//added by scpark below 2 functions.
bool CButtonST::SetTextFont( LONG nHeight, bool bBold, bool bItalic, const CString& sFaceName )
{
	LOGFONT lgfnt;
...
bool CButtonST::SetTextFont( const LOGFONT& lgfnt )
{
	m_Font.DeleteObject();
