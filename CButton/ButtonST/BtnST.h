...
// scpark
// added several functions for supporting font and color settings to ver. 3.9.
...
public:
	...
	{
		SetColor( BTNST_COLOR_FG_IN, crColor, false );
		SetColor( BTNST_COLOR_FG_OUT, crColor, false );
		SetColor( BTNST_COLOR_FG_FOCUS, crColor, bRepaint );
	}

	void SetBackColor( COLORREF crColor, bool bRepaint = true )
	{
		SetColor( BTNST_COLOR_BK_IN, crColor, false );
		SetColor( BTNST_COLOR_BK_OUT, crColor, false );
		SetColor( BTNST_COLOR_BK_FOCUS, crColor, bRepaint );
	}
...
*/
	...
	BCMenu*	GetMenu() { return (BCMenu*)(m_menuPopup.GetSubMenu(0)); }
#else
