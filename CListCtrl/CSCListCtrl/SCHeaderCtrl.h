...
static const UINT Message_CSCHeaderCtrl = ::RegisterWindowMessage(_T("MessageString_CSCHeaderCtrl"));

/////////////////////////////////////////////////////////////////////////////
// CSCHeaderCtrl window

class CSCHeaderCtrl : public CHeaderCtrl
{
// Construction
public:
	CSCHeaderCtrl();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CSCHeaderCtrl)
	//}}AFX_VIRTUAL

// Implementation
public:
	//virtual void DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct);
	virtual ~CSCHeaderCtrl();
