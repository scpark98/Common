...
public:
	...
	enum COLOR_THEME
	{
		...
		color_theme_darkgray,
		color_theme_daumpot,
	};
	static void		set_color_theme(int theme);
	static void		set_lf_height(int height);
	static void		set_line_height(int height);

	//scpark
	static int		m_color_theme;

	static COLORREF	m_cr_back;
	static COLORREF	m_cr_back_hilight;

	static COLORREF	m_cr_text;
	static COLORREF	m_cr_text_gray;
	static COLORREF	m_cr_text_hilight;

	static COLORREF	m_cr_separator;
	static COLORREF	m_cr_border;
	static COLORREF	m_cr_check;

	static int		m_lf_height;
	static int		m_line_height;
	static int		m_menu_min_width;
...
public:
	...
	//scpark
	void		set_color_theme(CNewMenu::COLOR_THEME theme);
	void		set_lf_height(int height);
