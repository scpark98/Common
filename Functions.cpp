...
//"c:\\abc/def\\123.txt" ¸¦ È£ÃâÇÏ¸é
//"c:"		"\\abc/def\\"		"123"		".txt" °ú °°ÀÌ ºÐ¸®µÇ´Âµ¥ ±âÁ¸¿¡ »ç¿ëÇÏ´ø ±â´ë°ª°ú ´Þ¶ó º¸Á¤ÇÑ´Ù.
//"c:\\"	"c:\\abc/def\\"		"123"		"txt"	"123.txt"¿Í °°ÀÌ º¸Á¤ÇÑ´Ù. Æú´õ´Â ¹Ýµå½Ã '/'·Î ³¡³ª´Â °ÍÀ¸·Î ÅëÀÏÇÑ´Ù.
//±âÁ¸¿¡´Â "abc/def"·Î Æú´õ¸íÀ» ¸®ÅÏÇßÀ¸³ª ±×°Í¸¸ ºÁ¼­´Â def°¡ Æú´õ¸íÀÎÁö ÆÄÀÏ¸íÀÎÁö ¾Ë ¼ö ¾ø±â ¶§¹®ÀÌ´Ù.
...
CString char2CString(char* chStr, int length)
{
	...
	//chStrÀÌ '\0'¹®ÀÚ·Î ³¡³ª´Â ¿ÂÀüÇÑ °ªÀÌ¶ó¸é
	//unicode¿¡¼­ str = (CString)chStr; ·Îµµ Á¤»ó µ¿ÀÛÇÑ´Ù. ¿¹¿Ü°¡ ÀÖ´ÂÁö È®ÀÎ ÇÊ¿ä!
