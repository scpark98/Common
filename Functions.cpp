...
int get_sub_folders(CString root, std::deque<CString>* list, bool special_folders, bool include_files)
{
	...
	if (root == _T(""))
	{
		folders.push_front(_T("¹ÙÅÁ È­¸é"));
		folders.push_front(_T("¹®¼­"));
...
void get_drive_map(std::map<TCHAR, CString> *drive_map)
{
	...
	// ¹ÝÈ¯ ¿¹ : "C:\\\0D:\\\0E:\\\0\0"
	// ±¸ºÐ : "\0", ³¡ : "\0\0"
	DWORD dwStringsLen = ::GetLogicalDriveStrings(MAX_PATH, tzDriveString); // ·ÎÄÃ µð½ºÅ© ¸ñ·Ï ¾ò±â
