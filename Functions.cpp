...
CString GetTimeStringFromTime(CTime t, CString sMark/*=":"*/, bool h24/*= true*/)
{
	...
	if (h24)
		...
		str.Format(_T("%s %2d%s%02d%s%02d"), (am ? _T("¿ÀÀü") : _T("¿ÀÈÄ")), (h >= 13 ? h - 12 : h), sMark, m, sMark, s);
...
CString	convert_volume_to_real_path(CString volume_path)
{
	...
	else if (volume_path == _T("´Ù¿î·Îµå"))
	{
#ifndef _USING_V110_SDK71_
