...
//trace(m_num);À¸·Î È£ÃâÇÏ¸é TRACE(_T("m_num = %d\n"));·Î Ä¡È¯µÈ´Ù.
//m_numÀÌ CStringÀÌ¸é elseÀı¿¡ ÀÇÇØ %s·Î Ãâ·ÂµÈ´Ù.
#define trace(n)\
{\
...
//¹®ÀÚ¿­
	...
	//´ëºÎºĞÀÇ °æ¿ì´Â get_token_string()À» »ç¿ëÇÏÁö¸¸ separator°¡ ¹®ÀÚ¿­ ³»¿¡ Æ÷ÇÔµÈ °æ¿ìµµ ÀÖÀ» ¼ö ÀÖ´Ù.
