...
struct RSRect
{
	...
	// of the object relative to the total change in the parent form뭩 width. 
	int top;    // Specifies the percentage change in the position of the top 
	// of the object relative to the total change in the parent form뭩 height.
	int width;  // Specifies the percentage change in the width of the object 
	// relative to the total change in the parent form뭩 width.
	int height; // Specifies the percentage change in the height of the object 
	// relative to the total change in the parent form뭩 height.
};
