...
/*
* Functions 등 대부분의 Common 코드에서 Gdiplus를 사용하므로 CSCGdiplusBitmap를 꼭 이용하지 않더라도
...
* 기존 CGdiPlusBitmap 및 CGdiPlusBitmapResource를 CSCGdiplusBitmap이라는 하나의 클래스로 합치고
  ...
  202509 : CSCGdiplusBitmap 클래스 이름 충돌이 발생하여 CSCGdiplusBitmap으로 변경함.
...
public:
	...
	*/
		...
		ULONG* pceltFetched) override
	{
		...
		{
			rgelt[fetched] = m_formats[m_index];
			rgelt[fetched].ptd = nullptr;   //같은 인덱스
			++fetched;
			++m_index;
		}
