...
public:
	...
	SOCKET			GetSocketByAlias( char* sAlias );
	char*			GetClientAlias( SOCKET sock );
	char*			GetClientAlias( int nClientPort );
	char*			GetClientAlias( const SockAddrIn& addrIn );
	char*			GetClientIPByAlias( char* sAlias );
	void			RemoveClient( int nIndex );
	void			RemoveClient( CString sAlias );
