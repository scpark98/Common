...
#ifndef _TEXTGRADOUTLINELASTSTRATEGY_H_
#define _TEXTGRADOUTLINELASTSTRATEGY_H_
...
public:
	//!  default constructor
	TextGradOutlineLastStrategy(void);
	//! destructor
	virtual ~TextGradOutlineLastStrategy(void);
...
#endif // _TEXTGRADOUTLINELASTSTRATEGY_H_