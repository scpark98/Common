...
namespace ffi
{
	...
	private:
		...
		//20260705 by claude. 파일 open/close 는 ffi::open_share_delete/close_share_delete(FILE_SHARE_DELETE custom-IO)
		//로 일원화 — 재생 중에도 탐색기 삭제·이름변경이 막히지 않는다. handle/AVIOContext 는 헬퍼가 소유.
