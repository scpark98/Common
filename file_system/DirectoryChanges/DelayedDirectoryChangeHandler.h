...
static const UINT Message_CDirectoryChangeWatcher = ::RegisterWindowMessage(_T("MessageString_CDirectoryChangeWatcher"));

class CDirectoryChangeWatcherMessage
{
public:
	CDirectoryChangeWatcherMessage(int _action, CString _filename0, CString _filename1 = _T(""))
	{
		action = _action;
		filename0 = _filename0;
...
public:
	CDelayedDirectoryChangeHandler(HWND hParent, CDirectoryChangeHandler * pRealHandler, bool bAppHasGUI, LPCTSTR szIncludeFilter, LPCTSTR szExcludeFilter, DWORD dwFilterFlags);
...
protected:
	...
	bool m_bAppHasGUI;	//	 pump, and that functions are dispatched to the main thread.
						...
						//
	DWORD m_dwFilterFlags = CDirectoryChangeWatcher::FILTERS_DONT_USE_FILTERS;
