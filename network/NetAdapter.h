...
//  
//  The class has been modified by Rafique Sheikh as follows:
//	i)	added function: tstring GetAdapterAddress(void); and
//  ii)	added function: void GetAdapterAddress(CByteArray& pAdapterAddress);

//  The first function returns formatted MAC address in HEX punctuated with hyphens "-"
//  The second function copies the adapter's address raw bytes into the CByteArray pointed
//  to by pAdapterAddress
//
///////////////////////////////////////////////////////////////////////////////////////////
